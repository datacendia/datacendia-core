...
export const MissionControlDashboard: React.FC = () => {
  ...
  return (
    <div className="p-4 lg:p-6 max-w-[1440px] mx-auto space-y-5">
      ...
      {/* ================================================================ */}
      {/* UNLOCK ENTERPRISE — passive upsell widget                        */}
      {/* ================================================================ */}
      <div className="bg-gradient-to-r from-indigo-500/[0.04] to-purple-500/[0.04] border border-indigo-500/15 rounded-xl p-5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-sm font-bold text-neutral-100">Unlock Enterprise Capabilities</h3>
              <p className="text-[11px] text-neutral-500 mt-0.5">
                Continuous compliance monitoring · CendiaLens explainability · 22 sovereign patterns · Crown Jewels dashboards
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <button
              onClick={() => navigate('/cortex/upgrade')}
              className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-lg text-xs font-semibold hover:bg-indigo-500 transition-colors"
            >
