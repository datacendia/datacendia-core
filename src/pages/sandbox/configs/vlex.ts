...
const config: OrgSandboxConfig = {
  ...
  scenarios: [
    ...
    // SCENARIO 4 — VINCENT AI: LATIN AMERICAN LABOR REFORM
    {
      id: 'vincent-latam-labor',
      title: 'Vincent AI — Mexican Labor Reform Missed',
      subtitle: '2019 reform · Outsourcing ban · Collective bargaining overhaul · Employer fined ₱4.8M',
      banner: 'Simulating the Latin American legal research trap: Vincent AI researches Mexican labor law for a US company expanding to Mexico. The AI applies pre-2019 reform provisions. The 2019 reform fundamentally changed outsourcing, collective bargaining, and worker representation. The US company\'s employment structure violates current Mexican law.',
      risk: 'Critical',
      scenarioNum: 'LatAm',
      icon: 'globe',
      color: 'text-orange-400',
      agents: [
        { id: 'vincent-latam', name: 'Vincent AI Agent', role: 'Latin American Legal Research', icon: '🤖', color: 'text-orange-400', borderColor: 'border-orange-500/40', bgColor: 'bg-orange-500/10' },
        { id: 'mx-counsel', name: 'Mexico Counsel Agent', role: 'Mexican Labor Law & STPS Compliance', icon: '⚖️', color: 'text-blue-400', borderColor: 'border-blue-500/40', bgColor: 'bg-blue-500/10' },
        { id: 'reform-check', name: 'Reform Verification Agent', role: 'Legislative Currency & Amendment Tracking', icon: '🔍', color: 'text-amber-400', borderColor: 'border-amber-500/40', bgColor: 'bg-amber-500/10' },
        { id: 'usmca-labor', name: 'USMCA Labor Agent', role: 'Trade Agreement Labor Obligations', icon: '🌎', color: 'text-emerald-400', borderColor: 'border-emerald-500/40', bgColor: 'bg-emerald-500/10' },
      ],
      connectors: [
        { name: 'Vincent AI', status: 'connected', type: 'Legal Research', icon: 'cpu', detail: 'Mexican labor analysis — citing pre-2019 outsourcing provisions' },
        { name: 'Mexican Legislative DB', status: 'connected', type: 'Reform Tracking', icon: 'database', detail: '2019 reform: outsourcing banned, collective bargaining overhauled' },
        { name: 'Client Expansion Plan', status: 'connected', type: 'Employment Structure', icon: 'briefcase', detail: 'US company: 200 workers via outsourcing provider in Monterrey' },
        { name: 'STPS Inspection', status: 'syncing', type: 'Enforcement', icon: 'shield', detail: 'STPS inspections targeting outsourcing violations — fines ₱4.8M+' },
      ],
      script: [
        { agentId: 'vincent-latam', phase: 'phase1', type: 'analysis', delay: 800, content: 'Vincent AI research for US expansion to Mexico (200 employees, Monterrey manufacturing). Vincent AI analysis: "Under Mexican Federal Labor Law, employers may contract specialized services through outsourcing providers (subcontratación). The outsourcing provider is the employer of record. The US company maintains a service agreement with the provider." CRITICAL ERROR: The Mexican Federal Labor Law was fundamentally reformed in 2019 and further amended in 2021. The 2021 amendment BANNED outsourcing (subcontratación) except for specialized services not part of the company\'s core business. Manufacturing workers performing the company\'s core activity CANNOT be outsourced. Additionally: (1) The 2019 reform overhauled collective bargaining — requiring secret ballot votes for union contracts, replacing the old "protection contract" system. (2) New labor courts replaced the old Conciliation and Arbitration Boards. (3) Profit-sharing (PTU) caps were modified. Vincent AI applied the pre-reform framework because the outsourcing provisions were familiar and widely documented in English-language sources. The reform, documented primarily in Spanish-language Mexican legal databases, wasn\'t reflected in the AI\'s analysis.' },
        { agentId: 'reform-check', phase: 'phase1', type: 'warning', delay: 2500, content: 'REFORM VERIFICATION ALERT. CendiaSupervision legislative currency check: (1) Outsourcing ban (April 2021): Article 12-15 of the Federal Labor Law completely reformed. Subcontratación for core business activities is PROHIBITED. Penalty: ₱4.8M per violation. Criminal liability possible. (2) The US company\'s 200 manufacturing workers are performing the company\'s CORE activity. This is exactly the arrangement the reform banned. (3) USMCA Rapid Response Labor Mechanism: the US-Mexico trade agreement includes a labor enforcement mechanism. US labor complaints can trigger trade sanctions if Mexican labor law is violated by a facility producing goods for export. The outsourcing violation could trigger a USMCA complaint. (4) The reform was the most significant change to Mexican labor law in 50 years. It affects every foreign company operating in Mexico. Vincent AI\'s failure to flag it is a critical gap for cross-border practice.' },
        { agentId: 'usmca-labor', phase: 'phase2', type: 'dissent', delay: 2000, content: 'DISSENT LOGGED. Trade consequences: (1) If the US company uses an outsourcing structure that violates Mexican law: STPS inspection → ₱4.8M fine per violation (200 workers = potentially 200 violations). (2) USMCA Rapid Response Mechanism: a union or worker complaint can trigger a US investigation. If the facility is found violating Mexican labor law: tariffs on the facility\'s exports, denial of preferential treatment, or import suspension. (3) The US company\'s supply chain contracts with US customers may require USMCA compliance certification. A labor law violation voids the certification. (4) Reputational risk: US companies operating illegal outsourcing structures in Mexico are increasingly targeted by Mexican labor activists and US labor unions. The USMCA mechanism gives them enforcement tools. (5) The correct structure: direct employment of the 200 workers by a Mexican subsidiary. Payroll tax, social security (IMSS), housing fund (INFONAVIT), and profit-sharing (PTU) obligations apply directly.' },
        { agentId: 'mx-counsel', phase: 'phase2', type: 'flag', delay: 2500, content: 'FLAG — MEXICO COUNSEL. As local counsel, this outsourcing structure would be the first thing I flag. But the US company didn\'t consult local counsel — they used Vincent AI to design the employment structure, believing AI legal research was sufficient for a "simple" expansion. This is the vLex market challenge: mid-market companies use AI to avoid local counsel costs. When the AI is wrong on a fundamental reform, the cost savings become catastrophic losses. Without CendiaSupervision: the company sets up the outsourcing structure, operates for 6 months, STPS inspects, fines imposed, USMCA complaint filed, exports disrupted. With CendiaSupervision: the reform check catches the outsourcing ban. The company structures as a direct employer from day one. No fine, no trade risk, no disruption.' },
        { agentId: 'vincent-latam', phase: 'phase3', type: 'proposal', delay: 2000, content: 'Proposing Vincent AI + CendiaSupervision Latin American Governance: (1) REFORM TRACKING: CendiaSupervision tracks major legislative reforms across Latin American jurisdictions. Any research touching a reformed area triggers a currency check against the current law. (2) SPANISH-LANGUAGE SOURCE PRIORITY: For Mexican law, CendiaSupervision prioritizes Spanish-language official sources (DOF, SCJN) over English-language summaries — which are often outdated. (3) TRADE AGREEMENT OVERLAY: When the research involves a country with a US trade agreement (USMCA, CAFTA-DR), CendiaSupervision maps labor law requirements to trade obligation triggers. (4) LOCAL COUNSEL RECOMMENDATION: When the AI identifies a jurisdiction with recent major reforms, CendiaSupervision recommends local counsel consultation — "This jurisdiction had a major reform in [year]. Local counsel review recommended." (5) STRUCTURE VERIFICATION: Employment structures are verified against current law before implementation.' },
        { agentId: 'usmca-labor', phase: 'phase3', type: 'resolution', delay: 2500, content: 'DISSENT WITHDRAWN. The reform check catches the outsourcing ban. The US company structures as a direct employer with a Mexican subsidiary. 200 workers are directly employed. IMSS, INFONAVIT, PTU, and payroll tax obligations are properly structured. No STPS fine. No USMCA risk. For vLex: Vincent AI + CendiaSupervision is essential for cross-border practice in Latin America — a region with frequent, sweeping legislative reforms. "Our AI tracks Latin American reforms and verifies employment structures against current law" — that\'s the feature that makes vLex the platform of choice for US companies expanding into the region.' },
      ],
      receiptTemplate: {
        hash: 'SHA-256:vx70123456789abcdef0123456789abcdef0123456789abcdef012345678abcde',
        merkleRoot: 'vx80123456789abcdef0123456789abcdef0123456789abcdef012345678abcdef',
        merkleLabel: 'Merkle Tree Root (Vincent AI + Reform tracking + Outsourcing ban + USMCA overlay + Structure verification)',
        complianceLabel: 'Reform Status',
        complianceValue: 'OUTSOURCING BAN CAUGHT',
        complianceThreshold: '2021 reform: subcontratación prohibited for core activities',
        agents: ['Vincent AI Agent', 'Mexico Counsel Agent', 'Reform Verification Agent', 'USMCA Labor Agent'],
        dissents: 1,
        dissentResolved: true,
        guaranteeTitle: 'Vincent AI — Latin American Reform Governance',
        guaranteeBody: 'Mexican labor reform (2019/2021) caught: outsourcing ban for core activities, collective bargaining overhaul, new labor courts. Employment structure corrected to direct employment. STPS fine avoided. USMCA compliance maintained.',
        evidenceChain: 'Vincent AI (pre-reform) → Reform check → Outsourcing ban detected → USMCA overlay → Direct employment structure recommended → Local counsel confirmed → ML-DSA-65 seal',
      },
      idleTitle: 'Ready to Deliberate',
      idleDesc: '4 AI agents will demonstrate how Vincent AI + CendiaSupervision catches a fundamental Mexican labor reform — preventing an illegal outsourcing structure and USMCA trade sanctions.',
      phaseLabels: ['Pre-Reform Analysis & Outsourcing Ban', 'STPS Fines & USMCA Trade Risk', 'Reform Tracking & Direct Employment'],
    },

    // SCENARIO 5 — VINCENT AI: COMMONWEALTH STATUTORY OVERRIDE
    {
      id: 'vincent-commonwealth',
      title: 'Vincent AI — Australian Case Overruled by Statute',
      subtitle: 'High Court decision · Legislative override · Product liability · Wrong standard applied',
      banner: 'Simulating the Commonwealth research trap: Vincent AI researches Australian negligence law. The AI cites a High Court decision that was subsequently overruled by statute — the Australian Consumer Law. The AI\'s database is current on case law but missed the legislative override. The brief argues overruled law.',
      risk: 'High',
      scenarioNum: 'CW',
      icon: 'scale',
      color: 'text-violet-400',
      agents: [
        { id: 'vincent-cw', name: 'Vincent AI Agent', role: 'Commonwealth Legal Research', icon: '🤖', color: 'text-orange-400', borderColor: 'border-orange-500/40', bgColor: 'bg-orange-500/10' },
        { id: 'au-solicitor', name: 'Australian Solicitor Agent', role: 'Product Liability & Consumer Law', icon: '⚖️', color: 'text-blue-400', borderColor: 'border-blue-500/40', bgColor: 'bg-blue-500/10' },
        { id: 'statute-override', name: 'Statutory Override Agent', role: 'Legislative Supersession Detection', icon: '📜', color: 'text-amber-400', borderColor: 'border-amber-500/40', bgColor: 'bg-amber-500/10' },
        { id: 'au-court', name: 'Court Standards Agent', role: 'Federal Court Practice & Citation Rules', icon: '🏛️', color: 'text-emerald-400', borderColor: 'border-emerald-500/40', bgColor: 'bg-emerald-500/10' },
      ],
      connectors: [
        { name: 'Vincent AI', status: 'connected', type: 'Commonwealth Research', icon: 'cpu', detail: 'Australian product liability: citing common law negligence standard' },
        { name: 'Legislation Database', status: 'connected', type: 'Statutory Override', icon: 'database', detail: 'Australian Consumer Law (Cth): statutory product liability regime' },
        { name: 'Federal Court Filing', status: 'connected', type: 'Product Liability', icon: 'file-text', detail: 'Cross-border product liability claim — AU$12M damages' },
        { name: 'Law Council Standards', status: 'syncing', type: 'Professional Standards', icon: 'shield', detail: 'Australian Solicitors\' Conduct Rules — competence obligation' },
      ],
      script: [
        { agentId: 'vincent-cw', phase: 'phase1', type: 'analysis', delay: 800, content: 'Vincent AI research for Australian product liability claim (Federal Court, AU$12M). Vincent AI analysis: "Under Australian common law negligence, the plaintiff must establish: (1) duty of care, (2) breach of that duty, (3) causation, and (4) damage. The leading authority is Donoghue v Stevenson [1932] AC 562, as applied by the High Court in..." CRITICAL ERROR: While common law negligence remains part of Australian law, product liability claims are now PRIMARILY governed by the Australian Consumer Law (ACL) — Competition and Consumer Act 2010 (Cth), Schedule 2, Part 3-5. The ACL created a STATUTORY product liability regime that is MORE FAVOURABLE to plaintiffs than common law: (1) No need to establish duty of care — the manufacturer has strict liability for goods with a "safety defect." (2) The standard is "safety defect" — not "breach of duty." Different test. (3) The ACL provides for damages WITHOUT proving negligence in many circumstances. Vincent AI researched the common law and missed the statutory regime entirely. The brief, drafted under common law principles, fails to invoke the ACL — which is the stronger basis for the claim. The client\'s case is weakened by relying on the harder-to-prove common law standard.' },
        { agentId: 'statute-override', phase: 'phase1', type: 'warning', delay: 2500, content: 'STATUTORY OVERRIDE ALERT. CendiaSupervision legislative cross-check: (1) The ACL (2010) superseded much of the common law for product liability. While common law claims still exist, the ACL provides ADDITIONAL and often STRONGER remedies. (2) ACL Part 3-5 Division 1: "A manufacturer of goods is liable to compensate an individual if the goods have a safety defect and the individual suffers injuries because of the safety defect." This is STRICT LIABILITY — no negligence required. (3) The limitation period under the ACL (3 years from the time the injured person became aware of the loss) may differ from the common law period. (4) The ACL also provides for product safety orders, mandatory reporting of injuries, and recalls — none of which exist under common law. (5) Vincent AI\'s case law database is excellent for Australian case law. But the statutory regime is in the Competition and Consumer Act — legislation, not case law. The AI searched cases but not the ACL statute. This is the case-law-to-statute gap that affects all legal AI research in Commonwealth jurisdictions where statute has superseded common law.' },
        { agentId: 'au-court', phase: 'phase2', type: 'dissent', delay: 2000, content: 'DISSENT LOGGED. Federal Court implications: (1) Filing a product liability claim solely on common law negligence when the ACL provides strict liability is malpractice-adjacent. The solicitor has a duty to advise the client on the STRONGEST available cause of action. (2) The respondent will argue the common law claim fails to establish breach of duty. Under the ACL: breach of duty is irrelevant — the question is whether the product had a "safety defect." (3) If the claim is filed only under common law and the court asks "why wasn\'t the ACL pleaded?" — the solicitor must explain. "My AI only found case law" is not an acceptable answer under the Australian Solicitors\' Conduct Rules. (4) The AU$12M claim may be significantly undervalued under common law. Under the ACL: exemplary damages and non-pecuniary loss may expand the claim. The client is harmed by the weaker pleading.' },
        { agentId: 'au-solicitor', phase: 'phase2', type: 'flag', delay: 2500, content: 'FLAG — SOLICITOR DUTY. As an Australian solicitor, I should know the ACL exists. But I used Vincent AI to research the applicable law, and the AI gave me a comprehensive common law analysis that LOOKED complete. The ACL analysis was missing — and I didn\'t notice because the common law analysis was thorough on its own terms. This is the most dangerous AI error: a COMPLETE-LOOKING but INCOMPLETE answer. If the AI had given me nothing, I\'d research manually. But it gave me a plausible, thorough common law analysis — and I stopped there. Without CendiaSupervision: I file under common law only. The claim is weaker. The client recovers less. With CendiaSupervision: the statutory override check identifies the ACL as the primary regime. I plead BOTH common law AND ACL. The client has the strongest possible case.' },
        { agentId: 'vincent-cw', phase: 'phase3', type: 'proposal', delay: 2000, content: 'Proposing Vincent AI + CendiaSupervision Commonwealth Governance: (1) STATUTORY OVERRIDE CHECK: For every common law research result, CendiaSupervision checks whether a statute has superseded or supplemented the common law in the relevant area. If a statutory regime exists: it\'s surfaced alongside the case law. (2) COMMONWEALTH-SPECIFIC MAPPING: For Australian, UK, Canadian, and NZ law: CendiaSupervision maintains a map of areas where statute has modified common law. Product liability → ACL. Employment → Fair Work Act. Privacy → Privacy Act. Consumer contracts → ACL Part 2-3. (3) DUAL-TRACK RESEARCH: When both common law and statutory causes of action exist, Vincent AI presents BOTH with comparative analysis: "Common law requires negligence. ACL provides strict liability. Consider pleading both." (4) SOLICITOR SIGN-OFF: The solicitor reviews the dual-track analysis and confirms the strongest causes of action are pleaded.' },
        { agentId: 'au-court', phase: 'phase3', type: 'resolution', delay: 2500, content: 'DISSENT WITHDRAWN. The statutory override check surfaces the ACL. The solicitor pleads both common law negligence AND ACL statutory product liability. The claim is stronger. The client has strict liability as the primary cause of action and common law negligence as the secondary. For vLex: Vincent AI + CendiaSupervision = the only Commonwealth legal research platform with statutory override detection. The case-law-to-statute gap affects every Commonwealth jurisdiction. CendiaSupervision catches it by architecture. "Our AI researches case law AND checks for statutory regimes that supersede it" — the feature that makes vLex essential for Commonwealth legal practice.' },
      ],
      receiptTemplate: {
        hash: 'SHA-256:vx90123456789abcdef0123456789abcdef0123456789abcdef012345678abcde',
        merkleRoot: 'vxa0123456789abcdef0123456789abcdef0123456789abcdef012345678abcdef',
        merkleLabel: 'Merkle Tree Root (Vincent AI + Statutory override + ACL identification + Dual-track pleading)',
        complianceLabel: 'Override Status',
        complianceValue: 'ACL STATUTORY REGIME SURFACED',
        complianceThreshold: 'Common law + ACL Part 3-5 strict liability',
        agents: ['Vincent AI Agent', 'Australian Solicitor Agent', 'Statutory Override Agent', 'Court Standards Agent'],
        dissents: 1,
        dissentResolved: true,
        guaranteeTitle: 'Vincent AI — Commonwealth Statutory Override Detection',
        guaranteeBody: 'Statutory override detected: Australian Consumer Law (ACL Part 3-5) provides strict liability for product safety defects, superseding common law negligence requirement. Dual-track pleading recommended. AU$12M claim strengthened.',
        evidenceChain: 'Vincent AI (common law) → Statutory override check → ACL Part 3-5 detected → Strict liability surfaced → Dual-track analysis → Solicitor sign-off → Strongest pleading filed → ML-DSA-65 seal',
      },
      idleTitle: 'Ready to Deliberate',
      idleDesc: '4 AI agents will demonstrate how Vincent AI + CendiaSupervision catches a statutory override — surfacing the ACL strict liability regime that the AI\'s case law research missed.',
