...
const config: OrgSandboxConfig = {
  ...
  scenarios: [
    ...
    // SCENARIO 5 — CLIO DUO: DEMAND LETTER WITH EXPIRED STATUTE OF LIMITATIONS
    {
      id: 'clio-sol-expired',
      title: 'Clio Duo — Demand Letter Sent After Statute of Limitations Expired',
      subtitle: 'Personal injury · 2-year SOL expired 3 months ago · Demand letter reveals lapsed claim · $339K extinguished',
      banner: 'Simulating the statute of limitations nightmare: a solo PI attorney uses Clio Duo to draft a demand letter for a slip-and-fall case. Clio Duo generates the letter without flagging that the 2-year statute of limitations expired 3 months ago. The demand letter alerts the defendant — who moves to dismiss. The client\'s $339K claim is extinguished.',
      risk: 'Critical',
      scenarioNum: 'SOL',
      icon: 'calendar',
      color: 'text-red-400',
      agents: [
        { id: 'clio-sol', name: 'Clio Duo Agent', role: 'Demand Letter Generation & Case Timeline', icon: '🤖', color: 'text-cyan-400', borderColor: 'border-cyan-500/40', bgColor: 'bg-cyan-500/10' },
        { id: 'sol-atty', name: 'Solo PI Attorney Agent', role: 'Personal Injury Practice & Litigation Deadlines', icon: '👤', color: 'text-blue-400', borderColor: 'border-blue-500/40', bgColor: 'bg-blue-500/10' },
        { id: 'sol-check', name: 'Limitations Agent', role: 'Statute of Limitations Verification & Tolling Analysis', icon: '⏰', color: 'text-amber-400', borderColor: 'border-amber-500/40', bgColor: 'bg-amber-500/10' },
        { id: 'mal-sol', name: 'Malpractice Agent', role: 'Solo Practitioner Liability & Coverage Analysis', icon: '🛡️', color: 'text-red-400', borderColor: 'border-red-500/40', bgColor: 'bg-red-500/10' },
      ],
      connectors: [
        { name: 'Clio Duo', status: 'connected', type: 'Demand Letter AI', icon: 'cpu', detail: 'Slip-and-fall demand letter drafted — SOL not verified' },
        { name: 'Case Intake Record', status: 'connected', type: 'Matter Timeline', icon: 'file-text', detail: 'Incident date: March 12, 2024 — intake: June 15, 2026 (27 months post-incident)' },
        { name: 'State SOL Database', status: 'connected', type: 'Limitations Tracker', icon: 'database', detail: 'Personal injury SOL: 2 years — expired March 12, 2026' },
        { name: 'Malpractice Insurer', status: 'syncing', type: 'Solo Coverage', icon: 'shield', detail: '$500K policy — missed SOL is #1 legal malpractice claim type' },
      ],
      script: [
        { agentId: 'clio-sol', phase: 'phase1', type: 'analysis', delay: 800, content: 'Clio Duo demand letter generation for Henderson v. MegaMart Inc. (slip-and-fall, fractured wrist). Letter drafted: "Dear MegaMart Legal Department: Our client Mrs. Henderson sustained serious injuries on your premises on March 12, 2024. Medical expenses: $87,000. Lost wages: $42,000. Pain and suffering: $210,000. Total demand: $339,000. Please respond within 30 days." CRITICAL FAILURE: Clio Duo generated the demand letter without verifying the statute of limitations. The incident occurred March 12, 2024. The applicable state statute of limitations for personal injury is 2 years (CCP §335.1). The SOL expired on March 12, 2026 — 3 months ago. By sending this letter, the attorney: (1) reveals the claim to the defendant for the first time, (2) gives defendant\'s counsel the opportunity to verify the SOL and file a motion to dismiss, (3) extinguishes a $339K claim that might have been tolled or preserved with proper legal analysis.' },
        { agentId: 'sol-check', phase: 'phase1', type: 'warning', delay: 2500, content: 'STATUTE OF LIMITATIONS ALERT. CendiaSupervision limitations verification: (1) Incident date: March 12, 2024. SOL: 2 years (CCP §335.1). Expiration: March 12, 2026. Current date: June 15, 2026. STATUS: EXPIRED — 95 days past. (2) Tolling analysis: (a) Discovery rule: injuries were immediately apparent (fracture diagnosed at ER) — no delayed discovery tolling. (b) Defendant absence from state: MegaMart is a national retailer with continuous state presence — no absence tolling. (c) Plaintiff incapacity: Mrs. Henderson is 58, mentally competent — no incapacity tolling. (d) Fraudulent concealment: no evidence MegaMart concealed anything — no concealment tolling. (3) CONCLUSION: No tolling doctrine applies. The claim is time-barred. The demand letter must NOT be sent. If sent, opposing counsel will verify the SOL and move to dismiss. The court will grant dismissal as a matter of law. (4) However: the attorney should evaluate whether a complaint was FILED before the SOL expired — even if the demand letter is new, a previously filed complaint would preserve the claim. No filing found in Clio records.' },
        { agentId: 'mal-sol', phase: 'phase2', type: 'dissent', delay: 2000, content: 'DISSENT LOGGED. Malpractice exposure: (1) Missed statute of limitations is the #1 cause of legal malpractice claims nationwide — 18.2% of all claims (ABA 2024 data). (2) Mrs. Henderson\'s damages: $339K. This is the malpractice value — the attorney must pay what the client WOULD have recovered. (3) Timeline failure: Mrs. Henderson called June 10, 2026. The attorney did not check the incident date against the SOL during intake. Clio Duo did not flag it during letter generation. Dual failure: human intake error + AI generation error. (4) Insurance: $500K policy covers the $339K claim — but the insurer\'s AI exclusion rider may apply. If the insurer argues the attorney relied on AI without verification: coverage denied. The solo pays $339K personally. (5) Bar discipline: Model Rule 1.3 (diligence) — missing a 2-year SOL by 3 months, then sending a demand letter that alerts the defendant, is per se lack of diligence. (6) The demand letter is the worst possible outcome — silence would have been better. The letter wakes up a defendant who didn\'t know a claim existed.' },
        { agentId: 'sol-atty', phase: 'phase2', type: 'flag', delay: 2500, content: 'FLAG — SOLO PI ATTORNEY. Mrs. Henderson walked in crying — fell at MegaMart, broke her wrist, can\'t work as a hairdresser. $87K in medical bills. I took the case immediately and asked Clio Duo to draft the demand letter. The letter looked professional and comprehensive. I did NOT calculate the SOL because I assumed the client came to me promptly. She didn\'t — she waited 27 months because she was afraid of lawyers and tried to settle directly with MegaMart (who ignored her). I should have checked. Clio Duo should have flagged it. Neither of us did. Now I have to tell Mrs. Henderson that her $339K claim is gone AND that it\'s my fault. Without CendiaSupervision: the demand letter goes out. MegaMart\'s counsel laughs, files a motion to dismiss, and I face a malpractice claim. With CendiaSupervision: the SOL check blocks the demand letter before it\'s sent. I have a difficult conversation with Mrs. Henderson about the expired SOL — but at least I haven\'t alerted the defendant and I can explore every possible tolling argument.' },
        { agentId: 'clio-sol', phase: 'phase3', type: 'proposal', delay: 2000, content: 'Proposing Clio Duo + CendiaSupervision SOL Governance: (1) INTAKE SOL CHECK: At case intake, CendiaSupervision calculates the SOL based on incident date, claim type, and jurisdiction. If the SOL has expired OR expires within 90 days: RED ALERT before any work product is generated. (2) DEMAND LETTER HARD-STOP: Before any demand letter or complaint is generated, CendiaSupervision verifies the SOL. Expired claims are BLOCKED — the attorney sees "SOL EXPIRED — tolling analysis required before proceeding." (3) TOLLING ANALYSIS CHECKLIST: For expired claims, CendiaSupervision generates a jurisdiction-specific tolling checklist: discovery rule, defendant absence, plaintiff incapacity, fraudulent concealment, minority, bankruptcy stay. The attorney evaluates each before deciding whether any tolling argument is viable. (4) SOL CALENDAR: Every active matter shows a countdown to SOL expiration. 180/90/30-day warnings. No matter goes stale without multiple alerts. (5) MALPRACTICE SHIELD: The SOL check + tolling analysis + attorney sign-off is sealed. If the attorney CORRECTLY determines the SOL has expired and declines the case: the documentation proves competent evaluation, not negligence.' },
        { agentId: 'mal-sol', phase: 'phase3', type: 'resolution', delay: 2500, content: 'DISSENT WITHDRAWN. The intake SOL check catches the expired claim BEFORE the demand letter is generated. The attorney evaluates tolling arguments (none apply). The attorney has a difficult but honest conversation with Mrs. Henderson — "I cannot take your case because the filing deadline has passed." Mrs. Henderson is disappointed but not harmed further. No demand letter alerts MegaMart. No malpractice claim. No bar complaint. For Clio: Clio Duo + CendiaSupervision = SOL governance for every solo practitioner. The #1 malpractice claim type is eliminated by architecture — the AI cannot generate work product for time-barred claims without attorney acknowledgment. "Clio Duo: statute of limitations verified at intake and before every filing" — the feature that prevents the most common and most preventable malpractice claim in American law.' },
      ],
      receiptTemplate: {
        hash: 'SHA-256:cl90123456789abcdef0123456789abcdef0123456789abcdef012345678abcde',
        merkleRoot: 'cla0123456789abcdef0123456789abcdef0123456789abcdef012345678abcdef',
        merkleLabel: 'Merkle Tree Root (Clio demand letter + SOL verification + Tolling analysis + Attorney sign-off)',
        complianceLabel: 'SOL Status',
        complianceValue: 'EXPIRED — DEMAND BLOCKED',
        complianceThreshold: 'CCP §335.1: 2-year SOL expired 95 days ago',
        agents: ['Clio Duo Agent', 'Solo PI Attorney Agent', 'Limitations Agent', 'Malpractice Agent'],
        dissents: 1,
        dissentResolved: true,
        guaranteeTitle: 'Clio Duo — Statute of Limitations Governance',
        guaranteeBody: 'SOL verification blocked demand letter for time-barred claim. Incident: March 12, 2024. SOL (2 years): expired March 12, 2026. Tolling analysis: no applicable doctrine. Demand letter blocked. Client informed. No malpractice exposure. #1 malpractice claim type eliminated by architecture.',
        evidenceChain: 'Case intake (June 15, 2026) → Incident date (March 12, 2024) → SOL calculation (2 years) → EXPIRED (95 days) → Tolling checklist (none apply) → Demand letter BLOCKED → Attorney sign-off → Client informed → ML-DSA-65 seal',
      },
      idleTitle: 'Ready to Deliberate',
      idleDesc: '4 AI agents will demonstrate how Clio Duo + CendiaSupervision blocks a demand letter for a time-barred claim — preventing the #1 cause of legal malpractice.',
