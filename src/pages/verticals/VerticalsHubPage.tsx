...
const verticals: Vertical[] = [
  ...
  },
  {
    ...
    roi: '100%',
    sovereignty: 100,
    description: 'Decision evidence for climate stress tests, ESG scoring, and TCFD/TNFD disclosures',
    keyMetric: '100% audit readiness',
    route: '/verticals/climate-risk',
    agents: ['Climate Risk Analyst', 'ESG Compliance Officer', 'Sustainability Auditor', 'Scenario Modeler'],
    compliance: ['TCFD', 'TNFD', 'EU CSRD', 'IFRS S1/S2', 'ECB Climate Risk Guide'],
    status: 'ga',
  },
  {
    id: 'fairness-ai',
    name: 'Fairness & Gender AI',
    icon: '⚖️',
    tier: 'growth',
    roi: '100%',
    sovereignty: 100,
    description: 'Bias detection, fairness evidence, and gender-disaggregated impact assessment for AI decisions',
    keyMetric: 'Regulatory compliance',
    route: '/verticals/fairness-ai',
    agents: ['Bias Auditor', 'Fairness Analyst', 'Demographic Impact Assessor', 'Ethics Compliance Officer'],
    compliance: ['ECOA', 'CFPB AI Guidance', 'EU AI Act Art. 10', 'ISO/IEC TR 24027'],
    status: 'ga',
  },
  // Tier 3: Coming Soon
  {
