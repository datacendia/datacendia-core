...
export const INDUSTRY_FRAMEWORKS: ComplianceFramework[] = [
  ...
  // ========== CLIMATE RISK AI GOVERNANCE (EXTENDED) ==========
  {
    id: 'tnfd',
    code: 'TNFD',
    name: 'TNFD',
    ...
    domain: 'industry',
    description: 'Framework for nature-related risk and opportunity disclosure in financial decisions',
    version: '1.0',
    jurisdiction: ['Global'],
    industries: ['All', 'Finance', 'Agriculture', 'Energy'],
    pillars: ['predict', 'helm', 'lineage', 'ethics'],
    controlCount: 38,
  ...
  },
  {
    id: 'ecb-climate',
    code: 'ECB-CLIMATE',
    name: 'ECB Climate Risk Guide',
    fullName: 'ECB Guide on Climate-related and Environmental Risks',
    domain: 'industry',
    description: 'ECB supervisory expectations for climate risk management in banking, including AI model governance for climate stress tests',
    version: '2020',
    jurisdiction: ['EU'],
    industries: ['Banking', 'Finance'],
    pillars: ['predict', 'helm', 'guard', 'ethics'],
    controlCount: 45,
    lastUpdated: new Date('2020-11-27'),
    status: 'active',
  },
  {
    id: 'issb-s1',
    code: 'ISSB-S1',
    name: 'IFRS S1',
    fullName: 'IFRS S1 General Requirements for Sustainability-related Financial Disclosures',
    domain: 'industry',
    description: 'Global baseline for sustainability disclosure including AI-driven ESG scoring governance',
    version: '2023',
    jurisdiction: ['Global'],
    industries: ['All', 'Finance'],
  ...
  },
  {
    ...
    domain: 'industry',
    description: 'Climate-specific disclosure requirements including scenario analysis and AI model governance for climate projections',
    version: '2023',
    jurisdiction: ['Global'],
    industries: ['All', 'Finance', 'Energy'],
    pillars: ['predict', 'helm', 'lineage', 'ethics'],
    controlCount: 38,
    lastUpdated: new Date('2023-06-26'),
    status: 'active',
  ...
  // ========== FAIRNESS & BIAS IN AI ==========
  {
    ...
    domain: 'industry',
    description: 'US law prohibiting discrimination in credit decisions — requires explainability and fairness evidence for AI-driven lending',
    version: '1974 (2024 Update)',
    jurisdiction: ['US'],
    industries: ['Finance', 'Banking', 'Lending'],
    pillars: ['ethics', 'lineage', 'predict', 'helm'],
    controlCount: 32,
    lastUpdated: new Date('2024-01-01'),
    status: 'active',
  },
  {
    ...
    fullName: 'ISO/IEC TR 24027 Bias in AI Systems and AI-Aided Decision Making',
    domain: 'ethical_ai',
    description: 'Technical report on identifying, measuring, and mitigating bias in AI systems — provides framework for fairness evidence and gender-disaggregated impact assessment',
    version: '2021',
    jurisdiction: ['Global'],
    industries: ['All'],
    pillars: ['ethics', 'predict', 'lineage', 'agents'],
    controlCount: 28,
    lastUpdated: new Date('2021-11-01'),
    status: 'active',
  },
  {
    id: 'cfpb-ai-fairness',
    code: 'CFPB-AI',
    name: 'CFPB AI Guidance',
    fullName: 'CFPB Guidance on AI/ML in Consumer Financial Services',
    domain: 'industry',
    description: 'CFPB requirements for adverse action notices, fair lending, and explainability when using AI/ML in consumer credit decisions',
    version: '2023',
    jurisdiction: ['US'],
    industries: ['Finance', 'Banking', 'Lending'],
    pillars: ['ethics', 'lineage', 'predict'],
    controlCount: 24,
    lastUpdated: new Date('2023-09-19'),
    status: 'active',
  },
  {
    id: 'eu-ai-act-fairness',
    code: 'EU-AI-ACT-ART10',
    name: 'EU AI Act Art. 10',
    fullName: 'EU AI Act Article 10 — Data Governance and Bias Mitigation',
    domain: 'ethical_ai',
    description: 'Specific requirements for training data governance, bias detection, and fairness testing in high-risk AI systems including gender and demographic impact assessment',
    version: '2024',
    jurisdiction: ['EU'],
    industries: ['All'],
    pillars: ['ethics', 'lineage', 'predict', 'agents'],
    controlCount: 18,
    lastUpdated: new Date('2024-03-13'),
    status: 'active',
  },
